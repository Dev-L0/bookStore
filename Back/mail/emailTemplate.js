...
export const WELCOME_MAIL = `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
table, td { color: #000000; } @media (max-width: 480px) { #u_content_image_3 .v-container-padding-padding { padding: 20px 10px 30px !important; } }
    </style>
...
<div class="u-row-container" style="padding: 0px;background-image: url('images/image-3.png');background-repeat: no-repeat;background-position: center top;background-color: #fdeed2">
...
<table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <!--[if mso]><table width="100%"><tr><td><![endif]-->
    <h1 style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 25px; font-weight: 700;"><span>Welcome to BS, {name} </span></h1>
...
<p style="line-height: 140%;"><span style="line-height: 19.6px;"><span style="color: #374151; font-family: __Inter_d65c78, __Inter_Fallback_d65c78, ui-sans-serif, system-ui, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'; font-size: 16px; white-space: normal; float: none; display: inline; line-height: 22.4px;">Welcome, {name} We are thrilled to have you join our community of book lovers. At Bookstore, we believe that every book is a doorway to a new adventure, and we’re excited to help you discover your next great read.</span>.</span></p>
  </div>
